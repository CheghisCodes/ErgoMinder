...
const initialReminders: Reminder[] = [
  {
    ...
    spokenPhrase: "It is time for your eye break.",
    enabled: true,
    frequency: 20,
  ...
  },
  {
    ...
    spokenPhrase: "It is time for a micro break.",
    enabled: true,
    frequency: 30,
  ...
  },
  {
    ...
    spokenPhrase: "It is time for a hydration break.",
    enabled: true,
    frequency: 60,
  ...
  },
  {
    ...
    spokenPhrase: "It is time for a snack break.",
    enabled: false,
    frequency: 120,
